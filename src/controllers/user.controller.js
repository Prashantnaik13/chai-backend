...
const loginUser = asyncHandler(async (req, res) => {
    ...
    //<-- alternamtive logic for check username and email -->
    ...
    //when we want does not show esential information to user like password, refreshToken
...
const updateAccountDetails = asyncHandler(async(req, res) => {
    ...
    const user = await User.findByIdAndUpdate(
        ...
        {
            $set :{
                fullName,  //fullName: fullName   Note: this way to initilization
                email  // email: email   Note: this is another way to initilization
            }
        },
        {
            new: true
...
const updateUserCoverImage = asyncHandler(async(req, res) => {
    ...
    .status(200)
    .json(
        new ApiResponse(200, updateCoverImage, "Cover Image is Updated Successfully")
    )
});
